...
/*******************************
-- Script out all SSIS environment variables for a single folder and environment. Must update the @folder and @env variables below
-- Script copied from: https://www.sqlservercentral.com/articles/scripting-environments-in-ssis-1
*******************************/
USE SSISDB;
